...
#define STRING_CONFIG_H_AUTHOR "si.maddison@icloud.com, @madman" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MadPrints"
...
#define DELTA
  ...
  // G33 Delta Auto-Calibration. Enable EEPROM_SETTINGS to store results.
    ...
    #define DELTA_RADIUS 132.25          // (mm) Get this value from G33 auto calibrate
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 277             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -2.81, 0.0, -1.41 } // (mm) Get these values from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.36 , -0.07 , 0.44 } // (mm) Get these values from G33 auto calibrate
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -15.55 }
